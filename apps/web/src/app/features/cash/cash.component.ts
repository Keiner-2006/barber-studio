    ...
    <div class="page">
      <div class="page-header">
        <div>
          ...
          <p class="subtitle">Gestiona apertura, cierre y transacciones de caja.</p>
        </div>
        <button class="primary-button">Abrir caja</button>
      </div>
      <div class="placeholder">
        <p>Módulo de caja en construcción</p>
        <p class="hint">Conectar con API de cash</p>
      </div>
    </div>
  `,
  styles: [`
