  ...
  template: `
    <div class="page">
      <div class="page-header">
        <div>
          <p class="label">Lunes, 7 de septiembre</p>
          <h1>Agenda <span class="accent">del día.</span></h1>
          <p class="subtitle">Gestiona turnos, disponibilidad y atención en tiempo real.</p>
        </div>
        <button class="primary-button">+ Nueva reserva</button>
      </div>
      <div class="placeholder">
        <p>Módulo de agenda en construcción</p>
        <p class="hint">Conectar con API de appointments</p>
      </div>
    </div>
  `,
  styles: [`
